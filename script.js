...
// ==========================================
const API_CONFIG = {
    // Use environment variable if available (Netlify), otherwise default to localhost
    baseUrl: window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
        ? 'http://localhost:8000'
        : (window.ENV?.API_URL || 'https://trinetra-backend.onrender.com'),

    get wsUrl() {
        // WebSocket URL based on HTTP/HTTPS
